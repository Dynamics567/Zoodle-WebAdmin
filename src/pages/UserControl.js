...
// Figure out away to do table across the 3 different pages, either give them their own components and dont kill
// yourself or stress over fitting it all in one component.
const UserControl = () => {
  const tableData = {
    headers: [
      "Order ID",
